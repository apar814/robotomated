...
title: "What Safety Standards and Compliance Do Robots Need?"
...
> **Quick Answer:** Robots need compliance with ISO 10218 (industrial robot safety), ISO/TS 15066 (collaborative robot force limits), and ANSI/RIA R15.06 (US-specific requirements). Every installation requires a documented risk assessment per ISO 12100, and in the US, OSHA's General Duty Clause mandates a hazard-free workplace with fines starting at $16,131 per serious violation. In the EU, CE marking under the Machinery Directive is mandatory.
...
### Q: Who is responsible for robot safety — the manufacturer or the buyer?
...
### Q: Do I need a safety consultant for robot deployment?
...
### Q: What are the force limits for collaborative robots under ISO/TS 15066?
...
### Q: What happens if OSHA investigates a robot incident at my facility?
...
- ISO 10218-1:2024 and ISO 10218-2:2024 — International Organization for Standardization, industrial robot safety requirements
- ISO/TS 15066:2016 — Collaborative robot safety, maximum allowable contact force specifications
- OSHA General Duty Clause (Section 5(a)(1)) — US workplace safety enforcement and penalty schedules
- ANSI/RIA R15.06-2012 (R2017) — Robotics Industries Association, US national standard for industrial robot safety
- European Commission Machinery Directive 2006/42/EC — CE marking and conformity requirements for robotic systems
- IEC 62443 — Industrial cybersecurity standards for networked automation systems
