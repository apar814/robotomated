...
const FEATURES = [
  { icon: "bell", title: "Unlimited Price Drop Alerts", desc: "Free tier: 3 alerts. Pro: unlimited across all 305+ robots. Never miss a deal.", free: "3 alerts", pro: "Unlimited" },
  ...
  { icon: "code", title: "Robot Database API Access", desc: "Programmatic access to our 305+ robot database. JSON API with full specs and scoring.", free: "None", pro: "Full API" },
