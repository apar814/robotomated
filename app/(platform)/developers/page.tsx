...
export default function DevelopersPage() {
    ...
    <div>
      ...
      <section className="border-b border-white/10 px-4 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          />
          <p className="mt-8 font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ DEVELOPER PORTAL ]</p>
      ...
      >
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ QUICKSTART ]</p>
  ...
  https://robotomated.com/api/v1/robots?limit=5`}</CodeBlock>
      ...
      <section className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ AUTH ]</p>
...
x-api-key: rtm_live_aBcDeFgH...`}</CodeBlock>
      ...
      <section id="endpoints" className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ ENDPOINTS ]</p>
          <h2 className="font-display mt-3 mb-8 text-2xl font-bold">
            Endpoints Reference
          </h2>
      ...
      <section className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ RESPONSE FORMAT ]</p>
          <h2 className="font-display mt-3 mb-6 text-2xl font-bold">
            Response Format
          </h2>
          <p className="mb-4 text-sm text-gray-400">
  ...
  "error": {
    ...
    "retry_after": 43200
      ...
      <section className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ CODE EXAMPLES ]</p>
          <h2 className="font-display mt-3 mb-8 text-2xl font-bold">
            Code Examples
          </h2>
...
for robot in data:
    print(f"{robot['name']} — RoboScore: {robot['robo_score']}")`}</CodeBlock>
      ...
      <section className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ RATE LIMITS ]</p>
      ...
      <section className="border-b border-white/10 px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ WEBHOOKS ]</p>
    ...
    "change_pct": -3.36
      ...
      <section className="px-4 py-20 text-center">
        <div className="mx-auto max-w-2xl">
          <p className="font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white/60">[ GET STARTED ]</p>
