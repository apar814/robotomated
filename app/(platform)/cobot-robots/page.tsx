    ...
    <div style={{ background: "var(--theme-bg)" }}>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <section className="space-y-10">
          ...
          <div className="my-12 border p-8 text-center" style={{ borderColor: "#1F1F1F", background: "#0A0A0A" }}>
            ...
            <Link href="/advisor" className="mt-4 inline-block border border-white/20 bg-transparent px-6 py-3 text-sm font-semibold text-white/80 hover:border-white hover:text-white">
              Ask Robotimus
            </Link>
          </div>
