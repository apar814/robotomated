  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)]">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <p className="mb-3 font-[family-name:var(--font-brand)] text-[13px] font-medium uppercase tracking-[0.15em] text-white">
            [ SITEMAP ]
          </p>
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {sections.map((section) => (
            <div key={section.title}>
              <h2 className="mb-4 font-[family-name:var(--font-brand)] text-[11px] font-medium uppercase tracking-[0.12em] text-white">
                {section.title}
              </h2>
