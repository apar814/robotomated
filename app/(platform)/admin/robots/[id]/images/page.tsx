...
export default function AdminRobotImagesPage() {
  ...
  if (!robot) return <div className="py-20 text-center text-white/50">Loading...</div>;
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-8">
        ...
        {images.length === 0 ? (
          <div className="glass-card p-8 text-center text-white/50">No images yet. Add a product photo URL below.</div>
        ) : (
              ...
              <div key={`${img.url}-${i}`} className="glass-card overflow-hidden">
                ...
                <div className="flex items-center justify-between p-3">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button onClick={() => moveImage(i, 1)} disabled={i === images.length - 1} className="rounded p-1 text-white/50 hover:text-white disabled:opacity-20">&#9660;</button>
                    <button onClick={() => removeImage(i)} className="rounded p-1 text-white/50 hover:text-orange">&#10005;</button>
                  </div>
                </div>
              </div>
            ))}
