        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link
              ...
              className="shrink-0 rounded-lg bg-[#0EA5E9] px-5 py-2.5 font-mono text-[10px] font-semibold tracking-wider text-black transition-shadow hover:shadow-[0_0_16px_rgba(14,165,233,0.3)]"
            >
              BECOME A PROVIDER
            </Link>
          </div>
          ...
          <form method="GET" action="/robowork/providers" className="flex flex-wrap items-end gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-lg border border-border bg-obsidian-surface px-3 py-2 font-sans text-xs text-text-primary placeholder:text-text-ghost focus:border-[#0EA5E9]/50 focus:outline-none"
              />
            </div>
            <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="rounded-lg border border-border bg-obsidian-surface px-3 py-2 font-sans text-xs text-text-primary focus:border-[#0EA5E9]/50 focus:outline-none"
              >
            ...
            <label className="flex items-center gap-2 py-2">
              <input
                ...
                className="h-4 w-4 rounded border-border bg-obsidian-surface accent-[#0EA5E9]"
              />
            ...
            <button
              type="submit"
              className="rounded-lg border border-[#0EA5E9]/30 bg-[#0EA5E9]/5 px-5 py-2 font-sans text-xs font-medium text-[#0EA5E9] transition-colors hover:bg-[#0EA5E9]/10"
            >
              Apply Filters
            </button>
          </form>
          ...
          {allProviders.length === 0 ? (
            <div className="rounded-xl border border-border bg-obsidian-surface p-12 text-center">
              ...
              <Link
                ...
                className="mt-4 inline-block font-sans text-xs font-medium text-[#0EA5E9] hover:underline"
              >
                Clear all filters
              </Link>
            </div>
                ...
                <div className="mt-10 flex items-center justify-center gap-2">
                  {page > 1 && (
                    <Link
                      ...
                      className="rounded-lg border border-border px-4 py-2 font-sans text-xs text-text-secondary transition-colors hover:border-[#0EA5E9]/30 hover:text-text-primary"
                    >
                      Previous
                    </Link>
                  )}
                    ...
                    .map((p, idx, arr) => (
                      <span key={p} className="flex items-center gap-2">
                        ...
                        <Link
                          ...
                          className={
                            p === page
                              ? "rounded-lg bg-[#0EA5E9]/10 px-3 py-2 font-mono text-xs font-medium text-[#0EA5E9]"
                              : "rounded-lg border border-border px-3 py-2 font-mono text-xs text-text-secondary transition-colors hover:border-[#0EA5E9]/30"
                          }
                        >
                          {p}
                        </Link>
