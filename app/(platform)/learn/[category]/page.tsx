          ...
          <div className="flex flex-wrap gap-2">
            ...
            {categories.map((cat) => (
              <Link
                ...
                className={
                  cat.slug === category
                    ? "rounded-full bg-white/5 px-4 py-2 text-sm font-medium text-white"
                    : "rounded-full border border-border px-4 py-2 text-sm text-muted transition-colors hover:border-white/20 hover:text-foreground"
                }
              >
                {cat.name} ({cat.count})
              </Link>
