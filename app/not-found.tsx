...
export default async function NotFound() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      <p className="font-[family-name:var(--font-brand)] text-7xl font-bold text-white/20 sm:text-8xl">
        404
      </p>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        <Link
          href="/advisor"
          className="rounded-lg border border-white/[0.08] px-6 py-2.5 text-sm font-medium text-white/60 transition-colors hover:border-white/20 hover:text-white"
        >
          Ask Robotimus
        </Link>
      </div>
