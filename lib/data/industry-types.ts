...
export const INDUSTRIES: Record<string, IndustryConfig> = {
  "warehouse-robotics": {
    ...
    marketStats: [
      { label: "Use Cases Covered", value: "5", subtext: "picking through loading" },
      { label: "Operation", value: "24/7", subtext: "lights-out capable" },
      { label: "Navigation", value: "Infrastructure-free", subtext: "AMRs need no floor changes" },
    ],
    types: [
  ...
  "medical-robotics": {
    ...
    marketStats: [
      { label: "da Vinci Procedures", value: "2.68M", subtext: "performed in 2024 (Intuitive Surgical FY2024 results)" },
      { label: "Regulatory Pathway", value: "FDA 510(k)", subtext: "required for US clinical use" },
      { label: "Robot Types", value: "5", subtext: "surgical to sanitation" },
    ],
    types: [
    ...
    buyerGuide: [
      { heading: "Surgical vs Rehabilitation vs Logistics", content: "Surgical robots ($1M-$4M) assist minimally invasive procedures. Rehabilitation robots ($100K-$500K) improve therapy consistency. Hospital logistics robots ($100K-$250K) automate supply and medication transport tasks that otherwise consume nursing time." },
    ...
    // Institution-attributed clinical case studies removed 2026-08-03 per
    // docs/claims-policy.md — outcome claims attributed to named hospitals
    // carried no citations. Renderer hides the section when empty.
    caseStudies: [],
  ...
  "manufacturing-robotics": {
    ...
    marketStats: [
      { label: "Robot Types", value: "5", subtext: "welding through cobots" },
      { label: "Operation", value: "24/7", subtext: "lights-out capable" },
      { label: "Cobot Programming", value: "No-code", subtext: "hand-guiding and teach pendants" },
    ],
    types: [
  ...
  "agricultural-robotics": {
    ...
    marketStats: [
      { label: "Use Cases Covered", value: "4", subtext: "spraying through monitoring" },
      { label: "Operation", value: "Day + night", subtext: "autonomous field work" },
      { label: "Application", value: "Precision", subtext: "targeted vs blanket treatment" },
    ],
    types: [
  ...
  "construction-robotics": {
    ...
    marketStats: [
      { label: "Use Cases Covered", value: "5", subtext: "bricklaying through demolition" },
      { label: "Deployment Model", value: "Retrofit", subtext: "existing equipment upgradeable" },
      { label: "Operation", value: "24/7", subtext: "not limited to shift hours" },
    ],
    types: [
  ...
  "delivery-robotics": {
    ...
    marketStats: [
      { label: "Deliveries", value: "8M+", subtext: "Starship alone (official press release)" },
      { label: "Operation", value: "All-weather", subtext: "rain and snow capable" },
      { label: "Speed", value: "Walking pace", subtext: "sidewalk-safe by design" },
    ],
    types: [
    ...
    caseStudies: [
      {
        ...
        challenge: "Serving large university campuses where car-based food delivery doesn't work in pedestrian zones.",
        solution: "Deployed fleets of autonomous sidewalk delivery robots per campus for food delivery from campus restaurants.",
        metrics: [
          { label: "Deliveries (global, official)", value: "8M+" },
          { label: "Fleet size at 5M milestone", value: "2,000+" },
        ],
      },
      {
        company: "Zipline",
  ...
  "security-robotics": {
    ...
    marketStats: [
      ...
      { label: "Route Completion", value: "Consistent", subtext: "no skipped patrols" },
      { label: "Sensors", value: "Multi-modal", subtext: "video, thermal, audio" },
    ],
    types: [
