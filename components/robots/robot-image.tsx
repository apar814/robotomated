...
function CategoryIcon({ name }: { name: string }) {
  const p = { width: 48, height: 48, viewBox: "0 0 24 24", fill: "none", stroke: "#0EA5E9", strokeWidth: 1.5, strokeLinecap: "round" as const, strokeLinejoin: "round" as const, style: { opacity: 0.4 } };
  switch (name) {
