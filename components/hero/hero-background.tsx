  ...
  const animate = useCallback(
    (timestamp: number) => {
      ...
      for (const node of nodes) {
        ...
        ctx.fillStyle = `rgba(14,165,233,${node.opacity * opacityScale})`;
        ctx.fill();
      }
    ...
    >
      ...
      <div
        style={{
          ...
          height: "70%",
          backgroundImage: `
            linear-gradient(to right, rgba(14,165,233,${0.06 * opacityScale}) 1px, transparent 1px),
            linear-gradient(to bottom, rgba(14,165,233,${0.06 * opacityScale}) 1px, transparent 1px)
          `,
      ...
      <div
        style={{
          ...
          right: 0,
          height: 1,
          background: `linear-gradient(to right, transparent 0%, rgba(14,165,233,0.4) 20%, rgba(14,165,233,0.8) 50%, rgba(14,165,233,0.4) 80%, transparent 100%)`,
