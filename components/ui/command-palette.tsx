  ...
  return (
    <>
      ...
      >
        <div
          ...
          style={{
            ...
            borderRadius: "16px",
            boxShadow:
              "0 0 0 1px rgba(255,255,255,0.06), 0 32px 80px rgba(0,0,0,0.8)",
          }}
        >
          {/* Corner brackets */}
              ...
              <>
                ...
                {QUICK_LINKS.map((link, i) => (
                  <ResultRow
                    ...
                    animDelay={i * 20}
                  >
                    <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="#D4D4D4" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M9 5l7 7-7 7" /></svg>
                      ...
                      return (
                        ...
                        >
                          <div
                            ...
                            style={{ borderRadius: "6px", background: "rgba(255,255,255,0.06)" }}
                          >
                            {"\ud83d\udcc1"}
                          </div>
          ...
          {hasQuery && (
            <button
              ...
              className="flex w-full items-center gap-3 text-left transition-colors duration-150 hover:bg-white/[0.08]"
              style={{
                padding: "12px 20px",
            ...
            >
              ...
              >
                <svg className="h-3 w-3" style={{ color: "#D4D4D4" }} fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-[11px] font-semibold" style={{ color: "#D4D4D4" }}>&rarr;</span>
            </button>
          )}
      ...
      <style jsx global>{`
        ...
        .cp-scroll::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.15); border-radius: 2px; }
        .cp-scroll::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.25); }
      `}</style>
    </>
  );
}
  ...
  return (
    <button
      ...
      style={{
        ...
        borderLeft: selected ? "2px solid #D4D4D4" : "2px solid transparent",
