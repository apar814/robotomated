  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        <Link
          href="/advisor"
          className="mt-5 inline-flex items-center gap-2 rounded-[4px] bg-white px-6 py-2.5 font-mono text-[13px] font-bold tracking-widest text-black transition-shadow hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]"
        >
          ASK ROBOTIMUS →
        </Link>
      </div>
