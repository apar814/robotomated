...
export const IconPalette = icon(({ size = 18, ...props }) => (
  <svg {...defaults(size)} {...props}>
    <circle cx="13.5" cy="6.5" r="1.5" fill="#0EA5E9" stroke="none" />
    <circle cx="17.5" cy="10.5" r="1.5" fill="#0EA5E9" stroke="none" />
    <circle cx="8.5" cy="7.5" r="1.5" fill="#0EA5E9" stroke="none" />
    <circle cx="6.5" cy="12.5" r="1.5" fill="#0EA5E9" stroke="none" />
