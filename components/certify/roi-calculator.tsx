    ...
    <div className="rounded-xl border border-border bg-[#0A0A0A] p-6 sm:p-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-[#111] py-2.5 pl-7 pr-3 font-mono text-sm text-white outline-none transition-colors focus:border-[#0EA5E9]"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full appearance-none rounded-lg border border-border bg-[#111] px-3 py-2.5 text-sm text-white outline-none transition-colors focus:border-[#0EA5E9]"
          >
            {LEVELS.map((l, i) => (
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-1 font-mono text-2xl font-bold text-[#0EA5E9]">
      ...
      <div className="mt-6 rounded-lg border border-[#0EA5E9]/20 bg-[#0EA5E9]/5 p-5 text-center">
        <p className="text-xs font-medium uppercase tracking-wider text-[#0EA5E9]">
          5-Year Cumulative Earnings Difference
        </p>
        <p className="mt-2 font-mono text-4xl font-extrabold text-[#0EA5E9] sm:text-5xl">
          {fiveYearDiff === 0
            ? "Priceless"
            : `+$${fmt(fiveYearDiff)}`}
        </p>
