      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href="/pro"
              className="rounded-lg bg-white px-4 py-2 text-xs font-semibold text-black transition-opacity hover:opacity-90"
            >
              Unlock — $49/mo
            </Link>
            <button
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full max-w-sm rounded-xl border border-white/10 bg-[#0A0A0A]/95 p-6 text-center backdrop-blur-sm">
          <p className="text-sm font-semibold text-white">{feature}</p>
          <p className="mt-2 text-xs text-white/40">{description}</p>
          <Link
            href="/pro"
            className="mt-4 inline-block rounded-lg bg-white px-5 py-2.5 text-xs font-semibold text-black transition-opacity hover:opacity-90"
          >
