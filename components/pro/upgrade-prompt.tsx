...
export function UpgradePrompt({ feature, description, inline }: UpgradePromptProps) {
  ...
  if (inline) {
    return (
      <div className="rounded-xl border border-[#0EA5E9]/15 bg-[#0EA5E9]/[0.03] p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              href="/pro"
              className="rounded-lg bg-[#0EA5E9] px-4 py-2 text-xs font-semibold text-black transition-opacity hover:opacity-90"
            >
              Unlock — $49/mo
            </Link>
            <button
      ...
      <div className="mx-4 w-full max-w-md rounded-2xl border border-white/[0.08] bg-[#0A0A0A] p-8 text-center shadow-2xl">
        <div className="mb-5 flex justify-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#0EA5E9]/10">
            <svg className="h-6 w-6 text-[#0EA5E9]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="mt-6 flex flex-col gap-3">
          <Link
            href="/pro"
            className="rounded-lg bg-[#0EA5E9] px-6 py-3 text-sm font-semibold text-black transition-opacity hover:opacity-90"
          >
            Start Free Trial
          </Link>
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-full max-w-sm rounded-xl border border-[#0EA5E9]/15 bg-[#0A0A0A]/95 p-6 text-center backdrop-blur-sm">
          <p className="text-sm font-semibold text-white">{feature}</p>
          <p className="mt-2 text-xs text-white/40">{description}</p>
          <Link
            href="/pro"
            className="mt-4 inline-block rounded-lg bg-[#0EA5E9] px-5 py-2.5 text-xs font-semibold text-black transition-opacity hover:opacity-90"
          >
