      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-lg border border-border bg-obsidian-surface p-8">
            ...
            <Link
              href="/certify"
              className="mt-8 inline-flex items-center justify-center gap-2 rounded-lg border px-7 py-3.5 text-[15px] font-semibold text-white transition-all hover:-translate-y-0.5 hover:border-[#0EA5E9] hover:text-[#0EA5E9]"
