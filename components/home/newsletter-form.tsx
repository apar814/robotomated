  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row sm:gap-0">
      <input
        ...
        className="flex-1 rounded-lg border border-border bg-navy-light px-4 py-3 text-sm text-foreground placeholder:text-muted focus:border-blue focus:outline-none sm:rounded-r-none"
      />
      <Button
        type="submit"
