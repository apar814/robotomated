    ...
    <section className="px-6 py-20" style={{ background: "var(--theme-section-alt)" }}>
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          >
            <p className="font-[family-name:var(--font-brand)] text-[10px] font-bold uppercase tracking-wider text-[#0EA5E9]">
              Real-World Example
            </p>
            ...
            <ol className="mt-5 space-y-0">
              {CASE_STEPS.map((step, i) => (
                ...
                >
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#0EA5E9]/20 font-[family-name:var(--font-brand)] text-[10px] font-bold text-[#0EA5E9]">
                    {i + 1}
                  </span>
                  {step}
                </li>
            ...
            <div className="mt-4 rounded-lg border border-[#0EA5E9]/25 bg-[#0EA5E9]/10 p-4 text-sm">
              <span className="font-semibold text-[#0EA5E9]">Result: </span>
