-- Combined pending migrations: 039_add_user_role, 039_workforce_network, 040_news_ingestion_v2
-- Generated 2026-08-10. Paste into Supabase SQL editor and run once.
-- NOTE: cohort seed uses CURRENT_DATE + 28 days — Cohort 1 will start 28 days after you run this.
...
-- ════════ Post-migration: grant admin (service-role context) ════════
