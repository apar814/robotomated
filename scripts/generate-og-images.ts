...
function buildOgSvg(opts: {
  ...
  <rect x="80" y="160" width="60" height="3" fill="#0EA5E9"/>
  <text x="80" y="210" font-family="Arial,Helvetica,sans-serif" font-size="14" fill="#0EA5E9" letter-spacing="4">ROBOTICS INTELLIGENCE PLATFORM</text>
  ...
  <text x="80" y="355" font-family="Arial,Helvetica,sans-serif" font-size="28" fill="#0EA5E9">${esc(subtitle)}</text>
  <rect x="80" y="390" width="1040" height="1" fill="#ffffff" fill-opacity="0.08"/>
  <text x="80" y="445" font-family="monospace" font-size="22" font-weight="700" fill="#C8FF00">${esc(stat1)}</text>
  ...
  <text x="420" y="445" font-family="monospace" font-size="22" font-weight="700" fill="#C8FF00">${esc(stat2)}</text>
  ...
  <text x="730" y="445" font-family="monospace" font-size="22" font-weight="700" fill="#C8FF00">${esc(stat3)}</text>
  ...
  <g fill="none" stroke="#0EA5E9" stroke-opacity="0.08" stroke-width="0.5">
  ...
  <g fill="#0EA5E9" fill-opacity="0.15">
