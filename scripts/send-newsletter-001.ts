...
const BOLT_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 200" width="140" height="175">
  ...
  <circle cx="80" cy="6" r="5" fill="#D4D4D4"/>
  <!-- Head -->
  ...
  <rect x="54" y="46" width="16" height="10" rx="2" fill="#D4D4D4"/>
  <rect x="88" y="44" width="20" height="14" rx="3" fill="#0F172A"/>
  <rect x="90" y="46" width="16" height="10" rx="2" fill="#D4D4D4"/>
  <!-- Grin -->
  ...
  <!-- Lightning bolt -->
  <polygon points="72,110 84,110 78,128 90,128 68,152 74,136 62,136" fill="#D4D4D4"/>
  <!-- Arms -->
...
function buildRobotCard(r: RobotCard, rank: number): string {
  ...
  const borderColor = rank === 1 ? "#D4D4D4" : rank === 2 ? "#94A3B8" : "#E2E4EA";
        ...
        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin-top:12px;width:100%;">
          <tr>
            <td style="font-family:${F};">
              <a href="https://robotomated.com/explore" style="color:#D4D4D4;text-decoration:none;font-size:12px;font-weight:700;letter-spacing:0.5px;font-family:${F};">VIEW ANALYSIS &rarr;</a>
            </td>
...
<table width="600" border="0" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td width="50%" style="padding:0 6px 12px 0;vertical-align:top;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFFFFF;border-top:3px solid #D4D4D4;">
  ...
  <tr>
    <td style="background:#EFF6FF;padding:24px 32px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-left:3px solid #D4D4D4;">
        <tr>
        ...
        <tr>
          <td style="padding:24px;font-family:${F};">
            ...
            <div style="margin-top:14px;">
              <a href="https://robotomated.com/market/funding" style="color:#D4D4D4;text-decoration:none;font-size:12px;font-weight:700;font-family:${F};">SEE ALL FUNDING ROUNDS &rarr;</a>
            </div>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td style="background:#0F1117;padding:0 32px 40px;text-align:center;border-top:1px solid #1E293B;">
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="center" style="margin-top:32px;">
        <tr>
          <td style="background:#D4D4D4;padding:14px 32px;">
...
async function main() {
  ...
  // 4. Funding highlight
  let fundingHighlight = "<strong style=\"color:#0F1117;\">Figure AI</strong> raised <strong style=\"color:#D4D4D4;\">$675M Series B</strong> led by Jeff Bezos, Microsoft, and NVIDIA &mdash; the largest humanoid robotics round ever. The round values Figure at $2.6B pre-money.";
  ...
  if (rounds && rounds.length > 0) {
    ...
    fundingHighlight = `<strong style="color:#0F1117;">${f.company}</strong> raised <strong style="color:#D4D4D4;">${f.amount} ${f.round || ""}</strong>${f.investors ? ` led by ${f.investors}` : ""}. Track all robotics funding rounds on our investment tracker.`;
  }
